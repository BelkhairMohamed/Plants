            ...
            <div class="navbar-sub-container">
                ...
                <div class="navbar-sub-menu" id="navbar-sub-menu">
                    ...
                    <div class="navbar-sub-menu-content">
                                ...
                                <div class="dropdown-menu-content">
                                    <div class="dropdown-menu-section">
                                        ...
                                        <ul class="dropdown-menu-list">
                                            ...
                                            <li><a href="<?php echo BASE_URL; ?>/?controller=plantCatalog&action=index&filter=self_watering">Self-Watering Plants</a></li>
                                            ...
                                            <li><a href="<?php echo BASE_URL; ?>/?controller=plantCatalog&action=index&pet_friendly=1">Pet-Friendly Plants</a></li>
                                            <li><a href="<?php echo BASE_URL; ?>/?controller=plantCatalog&action=index&filter=cold_weather">Cold Weather Plants</a></li>
                                            <li><a href="<?php echo BASE_URL; ?>/?controller=plantCatalog&action=index&filter=air_purifying">Air Purifying Plants</a></li>
                        ...
                        <a href="<?php echo BASE_URL; ?>/?controller=dashboard&action=index" class="navbar-sub-link">
